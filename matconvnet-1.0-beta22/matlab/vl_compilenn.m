...
lib_src{end+1} = fullfile(root,'matlab','src','bits',['nnmpn_cov.' ext]) ;
...
mex_src{end+1} = fullfile(root,'matlab','src',['vl_nnmpn_cov.' ext]) ;
...
lib_src{end+1} = fullfile(root,'matlab','src','bits','impl','mpn_cov_cpu.cpp') ;
...
if opts.enableGpu
  ...
  lib_src{end+1} = fullfile(root,'matlab','src','bits','impl','mpn_cov_gpu.cu') ;
end
