...
deep_model = 'imagenet-caffe-alex';  % 'imagenet-resnet-50-dag  imagenet-vgg-vd-16 imagenet-vgg-m  imagenet-caffe-alex
dataset        = 'ILSVRC2012';

opts.dataDir = fullfile(vl_rootnn, 'data', dataset) ;
opts.expDir = fullfile(vl_rootnn,'data', dataset, deep_model) ;
opts.modelPath = fullfile(vl_rootnn,  'pretrained', [deep_model '.mat']) ;
...
opts.train.batchSize = 1;    % lph 128-->1
