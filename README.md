...
### Classification results(top-1/top-5 error rates, %) on ImageNet 2012 validation set
 ...
 ---|:---:|:---:|:---:|:---:
 MPN-COV-ResNet-50 |22.27/6.35         |21.16/5.58     |[195.9MB](link)|[195.9MB](https://pan.baidu.com/s/1c2fG1S8)
 MPN-COV-ResNet-101 |21.17/5.70        |19.71/5.01     |[283.8MB](link)|[283.8MB](https://pan.baidu.com/s/1hsgonTq)
 MPN-COV-AlexNet |38.37/17.14          |34.97/14.60    |[594.5MB](link)|[594.5MB](https://pan.baidu.com/s/1boUndMn)
 MPN-COV-VGG-M   |34.63/14.64          |31.81/12.52    |[609.9MB](link)|[609.9MB](https://pan.baidu.com/s/1o8QJmgM)
 MPN-COV-VGG-16  |26.55/8.94           |24.68/7.75     |[643.8MB](link)|[643.8MB](https://pan.baidu.com/s/1c2csEsC)

  - The results and models above are obtained by training from scratch (random initialization), and the code is released [here](https://github.com/jiangtaoxie/demo/tree/master/imagenet).
  ...
  - The results either 1-crop or 10-crop  are evaluated using our [code](https://github.com/jiangtaoxie/demo/tree/master/evaluate), Note that the main difference from the code provided by MatConvNet is that we RESIZE an image using Matlab [imresize function](http://cn.mathworks.com/help/images/ref/imresize.html); the performance will decrease slightly if the resize function of MatConvNet is used.
...
1. We package our programs and [demos](https://github.com/jiangtaoxie/demo/tree/master/imagenet) in MatConvNet toolkit,you can download these [PACKAGE](link) directly, or in your Terminal type:
